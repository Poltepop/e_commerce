<nav class="bg-base-300 rounded-xl"  x-data="{ isOpen: false }" >
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/homepage" :active="request()->is('homepage')">Homepage</x-nav-link>
              ...
              <x-nav-link href="/form" :active="request()->is('form')">Form</x-nav-link>
            ...
            <div class="relative ml-3">
              ...
              x-transition:leave-end="opacity-0 scale-95" 
               ...
               <form action="/logout" method="post">
                @csrf
                  <button class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2" type="submit">Sign out</button>
              </form>
              </div>
            </div>
          </div>
    ...
    <div x-show='isOpen' class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Form</a>
